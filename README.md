...
- Automation status: Postgres brain schema foundation, observe-only sorter, active learned-rule matching, webmail review feedback, grouped sorting workbench, and learning metrics available
