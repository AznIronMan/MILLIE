...
function buildSeedRows(instanceId) {
  const rows = [
    ...
    },
    {
      ...
      value: "",
      description: "PostgreSQL password when database_mode is postgres. Stored in plain text for now.",
      options: "",
      secret: true,
    },
    {
    ...
    },
    {
      ...
      value: "",
      description: "Microsoft OAuth access token for Outlook/Exchange. Generated by the temporary OAuth helper and stored in plain text for now.",
      options: "",
      secret: true,
    },
    {
      ...
      value: "",
      description: "Microsoft OAuth refresh token for Outlook/Exchange. Generated by the temporary OAuth helper and stored in plain text for now.",
      options: "",
      secret: true,
    },
    {
...
function apiRows(prefix, label) {
  return [
    ...
    },
    {
      key: `${prefix}_api_key`,
      value: "",
      description: `${label} API key. Leave empty for local models. Stored in plain text for now.`,
      options: "",
      secret: true,
    },
    {
...
function saveSettings(payload) {
  ...
  for (const [key, rawValue] of Object.entries(values)) {
    ...
    statements.push(`
UPDATE settings
SET setting_value = ${sqlQuote(nextValue)},
...
function normalizeMailAccount(account, index, existing) {
  ...
  const password = clearPassword ? "" : (passwordInput === "" ? existingPassword : passwordInput);
...
<body>
  <header>
    ...
    <p class="subhead">Editing <code>millie.settings</code>. Secret fields are stored in plain text in this temporary developer tool; existing saved values stay hidden unless replaced or cleared.</p>
  </header>
  <main>
